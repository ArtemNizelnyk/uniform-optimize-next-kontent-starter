      ...
      <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        <div className="pl-4 flex items-center">
          <Link href="/[[...slug]]" as="/">
            <a
              aria-label="home"
              className="no-underline hover:no-underline font-bold text-2xl lg:text-4xl text-gray-800"
            >
              <Logo />
            </a>
          </Link>
        ...
        <div
          id="nav-content"
          className={`bg-white w-full flex-grow lg:flex lg:items-center lg:w-auto mt-2 lg:mt-0 lg:bg-transparent text-black p-4 lg:p-0 z-20 ${
